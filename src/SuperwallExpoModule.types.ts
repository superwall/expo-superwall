...
export type SuperwallEvent =
  ...
  | { event: 'enrichmentComplete'; userEnrichment?: Record<string, any>; deviceEnrichment?: Record<string, any> }
...
export type SuperwallExpoModuleEvents = {
   ...
   */
  onPaywallDismiss: (params: { paywallInfoJson: PaywallInfo; result: PaywallResult; handlerId: string }) => void;
  /**
   ...
   */
  subscriptionStatusDidChange: (params: { from: SubscriptionStatus; to: SubscriptionStatus }) => void;
  /**
   ...
   */
  handleLog: (params: { level: LogLevel; scope: LogScope; message: string | null; info: Record<string, any> | null; error: string | null }) => void;
  /**
   ...
   */
  onPurchase: (params: { productId: string; platform: "ios" }) => void;
  /**
